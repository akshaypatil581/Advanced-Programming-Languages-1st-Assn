...
Use \say{(1)}, not \say{Eq. (1)}
or \say{equation (1)}, except at the beginning of a sentence: \say{Equation (1) is . . .}
...
to the reference number, as in \cite{b3}---do not use \say{Ref. \cite{b3}} or
\say{reference \cite{b3}} except at the beginning of a sentence.
